...
public class RecyclerListAdapter extends RecyclerView.Adapter<RecyclerListAdapter.ViewHolder>
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
        ...
        public ViewHolder(final View itemView) {
            ...
            bookImageView = (ImageView) itemView.findViewById(R.id.list_item_image_id);
            titleTextView = (TextView) itemView.findViewById(R.id.list_item_title_text_id);
            authorTextView = (TextView) itemView.findViewById(R.id.list_item_author_text_id);
            publisherTextView = (TextView) itemView.findViewById(R.id.list_item_publ_text_id);
            publishedDateTextView = (TextView) itemView.findViewById(R.id.list_item_publ_date_text_id);
            pagesTextView = (TextView) itemView.findViewById(R.id.list_item_pages_text_id);
            categoriesTextView = (TextView) itemView.findViewById(R.id.list_item_categories_text_id);
            bookRatingBarView = (RatingBar) itemView.findViewById(R.id.list_item_ratingbar_id);
            ratingCountTextView = (TextView) itemView.findViewById(R.id.list_item_rating_count_text_id);
            listPriceTextView = (TextView) itemView.findViewById(R.id.list_item_list_price_text_id);
            retailPriceTextView = (TextView) itemView.findViewById(R.id.list_item_retail_price_text_id);
