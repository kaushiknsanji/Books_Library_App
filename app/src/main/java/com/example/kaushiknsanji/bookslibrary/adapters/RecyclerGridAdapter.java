...
public class RecyclerGridAdapter extends RecyclerView.Adapter<RecyclerGridAdapter.ViewHolder>
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
        ...
        ViewHolder(View itemView) {
            ...
            bookImageView = itemView.findViewById(R.id.grid_item_image_id);
            titleTextView = itemView.findViewById(R.id.grid_item_title_text_id);
            authorTextView = itemView.findViewById(R.id.grid_item_author_text_id);
            bookRatingBarView = itemView.findViewById(R.id.grid_item_ratingbar_id);
            ratingCountTextView = itemView.findViewById(R.id.grid_item_rating_count_text_id);
            listPriceTextView = itemView.findViewById(R.id.grid_item_list_price_text_id);
            retailPriceTextView = itemView.findViewById(R.id.grid_item_retail_price_text_id);
