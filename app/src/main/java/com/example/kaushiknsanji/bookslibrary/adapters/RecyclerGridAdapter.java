...
/**
 * Adapter Class of the RecyclerView whose layout 'R.layout.books_grid_item' is inflated by
...
public class RecyclerGridAdapter extends RecyclerView.Adapter<RecyclerGridAdapter.ViewHolder>
    ...
    private static final String LOG_TAG = RecyclerGridAdapter.class.getSimpleName();
    ...
    //Stores the layout resource of the grid item that needs to be inflated manually
    ...
    /**
     * Constructor of the Adapter {@link RecyclerGridAdapter}
     *
     * @param context   is the Context of the Activity/Application
     * @param resource  is the layout resource ID of the item view ('R.layout.books_grid_item')
     * @param bookInfos is the list of BookInfo objects which is the Dataset of the Adapter
     */
    public RecyclerGridAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<BookInfo> bookInfos) {
        mContext = context;
        mLayoutRes = resource;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
        ...
        public ViewHolder(View itemView) {
            ...
            bookImageView = (ImageView) itemView.findViewById(R.id.grid_item_image_id);
            titleTextView = (TextView) itemView.findViewById(R.id.grid_item_title_text_id);
            authorTextView = (TextView) itemView.findViewById(R.id.grid_item_author_text_id);
            bookRatingBarView = (RatingBar) itemView.findViewById(R.id.grid_item_ratingbar_id);
            ratingCountTextView = (TextView) itemView.findViewById(R.id.grid_item_rating_count_text_id);
            listPriceTextView = (TextView) itemView.findViewById(R.id.grid_item_list_price_text_id);
            retailPriceTextView = (TextView) itemView.findViewById(R.id.grid_item_retail_price_text_id);
